...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("fbf8b925-0af7-47b7-9ebd-c4884f2780ed"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Bomb_net;
	wire [0:0] tmpFB_0__Bomb_net;
	wire [0:0] tmpIO_0__Bomb_net;
	wire [0:0] tmpINTERRUPT_0__Bomb_net;
	electrical [0:0] tmpSIOVREF__Bomb_net;

	cy_psoc3_pins_v1_10
		#(.id("ac323ce3-399d-4d0f-8f0a-14930815a6e9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Bomb
		 (.oe(tmpOE__Bomb_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bomb_net[0:0]}),
		  .io({tmpIO_0__Bomb_net[0:0]}),
		  .siovref(tmpSIOVREF__Bomb_net),
		  .interrupt({tmpINTERRUPT_0__Bomb_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bomb_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
